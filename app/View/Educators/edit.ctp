...
<?php echo $this->Form->create('Educator'); ?>
	<fieldset>
		<legend><?php echo __('Edit Educator'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Educator.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Educator.id'))); ?></li>
